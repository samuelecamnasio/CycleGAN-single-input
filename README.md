...
- Train a model:
```
!python train.py --dataroot ./datasets/MRI2CT --name MRI2CT --model cycle_gan --display_id 0
```

- Test the model:
```
!python test.py --dataroot ./datasets/MRI2CT/testA --name MRI2CT --model test --no_dropout --num_test 2201
```
